...
Eindpunt: `api/pin?username=Zineb-yousfi&repo=github-readme-statistics`
...
```md
[![Top Talen](https://github-readme-statistics-pearl.vercel.app/api/top-langs/?username=Zineb-yousfi&exclude_repo=github-readme-statistics,anuraghazra.github.io)](https://github.com/Zineb-Yousfi/github-readme-statistics)
```
...
Sinds de GitHub API alleen maar 5k verzoeken per uur toestaat, zou mijn `https://github-readme-statistics-pearl.vercel.app/api` mogelijk de rate limiet behalen. Als je het op je eigen Vercel server host, dan hoef je je nergens zorgen om te maken. Klik op de deploy knop om te beginnen!
