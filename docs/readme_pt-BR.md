 ...
 <p align="center">Adicione suas estatísticas no GitHub geradas dinamicamente em seus readmes!</p>
  ...
  <p align="center">
    <a href="https://github.com/Zineb-Yousfi/github-readme-statistics/actions">
      <img alt="Testes aprovados" src="https://github.com/Zineb-Yousfi/github-readme-statistics/workflows/Test/badge.svg" />
    </a>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/Zineb-Yousfi/github-readme-statistics/issues/new?assignees=&labels=bug&projects=&template=bug_report.yml">Reportar erros</a>
    ·
    <a href="https://github.com/Zineb-Yousfi/github-readme-statistics/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml">Solicitar recursos</a>
  </p>
  <p align="center">
...
Como a API do GitHub permite apenas 5 mil solicitações por hora, é possível que minha `https://github-readme-statistics-pearl.vercel.app/api` atinja a cota limite. Se hospedar em seu próprio servidor Vercel, não precisará se preocupar com nada. Clique no botão de implantação para começar!

Nota: Desde [#58](https://github.com/Zineb-Yousfi/github-readme-statistics/pull/58) há possibilidade de lidar com mais de 5 mil chamadas por hora, sem interrupções :D
